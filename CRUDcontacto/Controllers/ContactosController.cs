...
namespace CRUDcontacto.Controllers
{
    public class ContactosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Telefono,Correo,Direccion")] Contacto contacto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Telefono,Correo,Direccion")] Contacto contacto)
        {
            if (id != contacto.Id)
            {
                return NotFound();
